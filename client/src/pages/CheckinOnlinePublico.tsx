...
import { Select, SelectContent as BaseSelectContent, SelectItem as BaseSelectItem, SelectTrigger, SelectValue } from "@/components/ui/select";
...
export default function CheckinOnlinePublico() {
  ...
  const submit = async (event: React.FormEvent) => {
    ...
    if (guests.some((guest) => requiresDocumentSupportForNationality(guest.documentType, guest.nationality) && !guest.documentSupport.trim())) {
