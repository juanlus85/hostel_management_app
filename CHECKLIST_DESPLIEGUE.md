...
**Causa:** .env no está en la raíz o Plesk no las carga
**Solución:**
...
1. [ ] Hacer cambios en Manus
2. [ ] Probar en Manus
3. [ ] Ejecutar `./prepare-deploy.sh`
4. [ ] Descargar nuevo ZIP
5. [ ] Hacer backup del servidor actual
6. [ ] Subir nuevos archivos
7. [ ] Ejecutar `pnpm db:push` si hay cambios en BD
8. [ ] Reiniciar: `pm2 restart all`
