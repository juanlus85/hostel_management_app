...
export const hostelSettingsCheckin = mysqlTable("hostel_settings_checkin", {
  ...
  reservationCheckinEmailEs: text("reservationCheckinEmailEs"),
  reservationCheckinEmailEn: text("reservationCheckinEmailEn"),
  reservationWelcomeWhatsappEs: text("reservationWelcomeWhatsappEs"),
  reservationWelcomeWhatsappEn: text("reservationWelcomeWhatsappEn"),
  reservationCheckinWhatsappEs: text("reservationCheckinWhatsappEs"),
  reservationCheckinWhatsappEn: text("reservationCheckinWhatsappEn"),
